...
const SingleProduct = () => {
  ...
  const props = {
    ...
    // img: `${location?.state?.product.product_image}`,
  };
          ...
          <div className="col-6">
            <div className="main-product-details">
              ...
              <div className="border-bottom py-3">
                ...
                <p className="price">
                  {location?.state?.product.discount > 0 ? (
                    <>
                      <strike className="m-2">
                        Tk.{location?.state?.product.price}
                      </strike>
                      Tk.
              ...
              <div className=" py-3">
                ...
                <div className="d-flex gap-10 align-items-center my-2">
                  ...
                  <p className="product-data">
                    {location?.state?.product.categorie_name}
                  </p>
                </div>
                {/* <div className="d-flex gap-10 align-items-center my-2">
                ...
                <div className="d-flex gap-10 align-items-center my-2">
                  ...
                  <p className="product-data">
                    {" "}
                    {location?.state?.product.available_product > 0 ? (
                      <>
                        {location?.state?.product.available_product} Pieces
                        available
                      </>
                    ) : (
                      <>Out Of Stock</>
